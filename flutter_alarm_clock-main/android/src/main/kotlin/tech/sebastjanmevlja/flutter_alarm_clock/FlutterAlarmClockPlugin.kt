...
class FlutterAlarmClockPlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when {
            ...
            call.method.equals("createAlarm") -> {
                ...
                val days = call.argument<ArrayList<Int>>("days")
                if (hour != null && minutes != null && days != null) {
                    createAlarm(hour, minutes, days, title, skipUi)
                } else {
            ...
            call.method.equals("deleteAlarm") -> {
                ...
                if (hour != null && minutes != null) {
                    deleteAlarm(hour, minutes, skipUi)
                } else {
     ...
     */
    private fun createAlarm(hour: Int, minutes: Int, days :ArrayList<Int>, title: String? = "", skipUi: Boolean? = true) {
     ...
     */
    @RequiresApi(Build.VERSION_CODES.KITKAT)
    private fun deleteAlarm(hour: Int, minutes: Int, skipUi: Boolean? = true) {
